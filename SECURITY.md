...
- `@minions-alerts/sdk` (npm package)
- `minions-alerts` (PyPI package)
- `@minions-alerts/cli` (npm package)
- The minions-alerts web playground
- The minions-alerts documentation site
