...
/**
 * @minions-alerts/cli — CLI for Minions Alerts
 *
...
import { customTypes } from '@minions-alerts/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Alerts'));
        console.log(chalk.dim('Alert rules, delivery preferences, and alert history for availability changes'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-alerts/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-alerts/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-alerts')}`);
